...
static int32_t get_current_day(void) {
  ...
  //
  // The exact absolute value doesn't matter. We only need
  // it to change when the local date changes.
...
// If the saved game was already completed,
